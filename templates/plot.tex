...
\pgfplotsset{
  ...
  ((* else *))
  every axis plot/.append style={thin, mark size=1.2pt}
  ((* endif *))
}
...
\begin{tikzpicture}
  \begin{((( axistype )))}[
    ...
    ((* if multiplex *))
    \addplot+[((( linestyle )))]
    table [x index=((( loop.index0 ))), y index=((( loop.length + loop.index0 ))), col sep=comma]{\dtapth}((( '' if useNodes else ';' )))
    ((( '' if useNodes else '%' )))node[pos=0.5, above] {\footnotesize ((( leg )))};
    ((* else *))
    \addplot+[((( linestyle )))]
    table [x index=0,y index=((( loop.index ))),col sep=comma]{\dtapth}((( '' if useNodes else ';' )))
    ((( '' if useNodes else '%' )))node[pos=0.5, above] {\footnotesize ((( leg )))};
    ((* endif *))
    ...
    table [x index=((( loop.index0 ))), y index=((( loop.length + loop.index0 ))), col sep=comma]{\dtapth};
    ((* else *))
    \addplot+[((( linestyle ))), mesh, point meta=((( z )))]
